...
class DreamConfig(Base):
    ...
    disabled: bool = Field(default=False)  # Disable dream consolidation entirely
...
class HeartbeatConfig(Base):
    ...
    # Matron: when true, wake the agent by publishing a synthetic InboundMessage
    # into the agent's real session (preserves full conversation context).
    # When false, falls back to the legacy shadow-session path.
    use_deliver: bool = True
